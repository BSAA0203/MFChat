...
CMFChatServerDlg::CMFChatServerDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFCHAT_SERVER_DIALOG, pParent)
{
...
void CMFChatServerDlg::OnDestroy()
{
	CDialogEx::OnDestroy();
